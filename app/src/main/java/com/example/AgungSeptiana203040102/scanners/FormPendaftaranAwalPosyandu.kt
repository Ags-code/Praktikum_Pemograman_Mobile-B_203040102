...
import com.example.AgungSeptiana203040102.ui.theme.Purple700
import com.example.AgungSeptiana203040102.ui.theme.Teal200
...
fun FormPendaftaranAwalPosyandu() {
    ...
    Column(modifier = Modifier
        .padding(10.dp)
        .fillMaxWidth()) {
        OutlinedTextField(label = { Text(text = "NIK")}, value = nik.value, onValueChange = {nik.value = it},
        modifier = Modifier
            .padding(4.dp)
            .fillMaxWidth(),
